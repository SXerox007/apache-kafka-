...
# or
kafka-console-producer.sh --broker-list 12.0.0.1:9092 --topic name_of_topic
...
# or
kafka-console-producer.sh --broker-list 12.0.0.1:9092 --topic name_of_topic --producer-property acks=all
...
# or
kafka-console-producer.sh --broker-list 12.0.0.1:9092 --topic name_of_topic_not_exist
