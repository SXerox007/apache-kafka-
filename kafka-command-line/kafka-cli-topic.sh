...
# or
kafka-topics.sh --zookeeper 12.0.0.1:2181 --topic name_of_topic --create --partition 3 --replication-factor 1
...
# or
kafka-topics.sh --zookeeper 12.0.0.1:2181 --list
...
# or
kafka-topics.sh --zookeeper 12.0.0.1:2181 --topic name_of_topic --describe
...
# or
kafka-topics.sh --zookeeper 12.0.0.1:2181 --topic name_of_topic --delete